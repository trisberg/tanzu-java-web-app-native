...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=trisberg&repo=tanzu-java-web-app-native'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#nativeBuild && #buildTool == 'maven') evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
